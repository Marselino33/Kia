...
func (h *AdminController) ListVaksinAdmin(c echo.Context) error {
...
func (h *AdminController) GetVaksinAdmin(c echo.Context) error {
	idStr := c.Param("id")
	...
	return helpers.StandardResponse(c, http.StatusOK, "berhasil", v, nil)
}

func (h *AdminController) CreateVaksin(c echo.Context) error {
	var v models.MasterVaksin
	if err := c.Bind(&v); err != nil {
		return helpers.StandardResponse(c, http.StatusBadRequest, "request tidak valid: "+err.Error(), nil, nil)
	}
	if err := h.db.Create(&v).Error; err != nil {
		return helpers.StandardResponse(c, http.StatusBadRequest, "gagal membuat vaksin: "+err.Error(), nil, nil)
	}
	return helpers.StandardResponse(c, http.StatusCreated, "vaksin berhasil dibuat", v, nil)
}

func (h *AdminController) UpdateVaksin(c echo.Context) error {
	idStr := c.Param("id")
	id, err := strconv.Atoi(idStr)
	if err != nil {
		return helpers.StandardResponse(c, http.StatusBadRequest, "id tidak valid", nil, nil)
	...
	if err := h.db.Save(&v).Error; err != nil {
		return helpers.StandardResponse(c, http.StatusInternalServerError, "gagal memperbarui vaksin", nil, nil)
	}
	return helpers.StandardResponse(c, http.StatusOK, "vaksin diperbarui", v, nil)
}

func (h *AdminController) DeleteVaksin(c echo.Context) error {
	idStr := c.Param("id")
	id, err := strconv.Atoi(idStr)
	if err != nil {
		return helpers.StandardResponse(c, http.StatusBadRequest, "id tidak valid", nil, nil)
	}
	if err := h.db.Delete(&models.MasterVaksin{}, id).Error; err != nil {
		return helpers.StandardResponse(c, http.StatusInternalServerError, "gagal menghapus vaksin", nil, nil)
	}
	return helpers.StandardResponse(c, http.StatusOK, "vaksin dihapus", nil, nil)
}
